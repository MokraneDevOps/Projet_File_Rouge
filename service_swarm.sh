...
# Variables
IMAGE_NAME="mokrane921/image-gretops" # Nom de l'image Docker
IMAGE_TAG="latest" # Tag de l'image Docker
SERVICE_NAME="deploy_service" # Nom du service Docker
PORT_MAPPING="3000:3000" # Mappage de port pour le service Docker
